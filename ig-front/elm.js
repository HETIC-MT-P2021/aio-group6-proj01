...
var $author$project$Categories$Category = F5(
	function (id, title, images, addedAt, updatedAt) {
		return {addedAt: addedAt, id: id, images: images, title: title, updatedAt: updatedAt};
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$ul, _List_Nil, images),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
